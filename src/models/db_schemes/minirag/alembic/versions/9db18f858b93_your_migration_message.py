...
Revision ID: 9db18f858b93
Revises: e6db39be813e
Create Date: 2025-11-29 22:26:45.555390
...
def upgrade() -> None:
    ...
    sa.Column('data_chunk_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('data_chunk_uuid', sa.UUID(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('data_chunk_id'),
    sa.UniqueConstraint('data_chunk_uuid')
    )
